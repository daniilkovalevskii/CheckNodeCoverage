...
private slots:
    void testValidateStructure_data()
    {
        ...
        QTest::newRow("Тест 2: Дерево содержит цикл") << EdgeList{{"a", "b"},
                                                                  {"b", "c"},
                                                                  {"b", "d"},
                                                                  {"d", "e"},
                                                                  {"e", "a"}}
        ...
        QTest::newRow("Тест 7: Граф состоит из двух несвязных компонент, в одной из которых наушен алфавитный порядок имен узлов") << EdgeList{{"a", "b"},
                                                                                                                                               {"b", "c"},
                                                                                                                                               {"c", "d"},
                                                                                                                                               {"h", "g"},
                                                                                                                                               {"g", "f"},
